                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="index.php?lost-password">Reset</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div class="col-lg-12">
<center><a href="index.php?shop"><h1 class="gl-h1" style="padding:0;">BROWSE OUR SHOP</h1></a></center>
                            ...
                            <div class="col-lg-4 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <form class="l-f-o__form" method="post" action="#/" onsubmit="lost_password();return false;">
                                            
                                            <div class="u-s-m-b-30">
                                                <label class="gl-label" for="login-email">USERNAME OR E-MAIL *</label>
                                                <input class="input-text input-text--primary-style" type="text" id="username" placeholder="Enter Username / E-mail" required>
                                        	</div>
